...
"""Handshake retry and timeout configuration for auto-wiring (OMN-7657)."""
...
class ModelHandshakeConfig(BaseModel):
    ...
    Controls how the auto-wiring engine retries failed handshake
    checks before quarantining a contract.
    """
