...
Example:
    >>> from omnibase_infra.nodes.node_architecture_validator.models import ModelRuleCheckResult
    >>>
...
See Also:
    omnibase_infra.nodes.node_architecture_validator.protocols.ProtocolArchitectureRule:
