...
class TestInfraValidatorConstants:
    ...
    def test_infra_max_unions_constant(self) -> None:
        ...
        Current: 132 (as of healthcheck probe fix). Target: Keep below 150 - if this grows, consider typed patterns from omnibase_core.
        """
        assert INFRA_MAX_UNIONS == 132, (
            "INFRA_MAX_UNIONS should be 132 (non-optional unions only, X | None excluded)"
        )
